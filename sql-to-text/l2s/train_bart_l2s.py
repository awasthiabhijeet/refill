...
OUT_DIR = '../../models/sql-to-text/l2s/'
TRAIN_PATH = '../../data/sql-to-text/l2s/jsons/train_spider_l2s.json'
DEV_PATH = '../../data/sql-to-text/l2s/jsons/dev_l2s.json'
